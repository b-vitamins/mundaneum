...
async def get_entry_s2(
    ...
    return await get_entry_s2_meta(db, entry_id)
...
async def get_citations(
    ...
    return await get_related_s2_papers(db, entry_id, relation="citations")
...
async def get_references(
    ...
    return await get_related_s2_papers(db, entry_id, relation="references")
